                    ...
                    <div className="row g-5">
                        ...
                        <div className="col-md-12 col-lg-6 col-xl-5">
                                ...
                                <table className="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">
                                                <div className="d-flex align-items-center mt-2">
                                                    <img src={product3} className="img-fluid " style={{width: '90px', height: '90px'}} alt="" />
                                                </div>
                                            </th>
                                            <td className="py-5">HIPPO Power Bank Fast Charging</td>
                                            <td className="py-5">IDR 209.000</td>
                                            <td className="py-5">2</td>
                                            <td className="py-5">IDR 418.000</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">
                                                <div className="d-flex align-items-center mt-2">
                                                    <img src={product5} className="img-fluid" style={{width: '90px', height: '90px'}} alt="" />
                                                </div>
                                            </th>
                                            <td className="py-5">Robot Power bank</td>
                                            <td className="py-5">IDR 135.000</td>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div className="d-flex align-items-center mt-2">
                                                    <img src={product7} className="img-fluid " style={{width: '90px', height: '90px'}} alt="" />
                                                </div>
                                            </th>
                                            <td className="py-5">Redmi Power Bank</td>
                                            <td className="py-5">IDR 640.000</td>
                                            <td className="py-5">1</td>
                                            <td className="py-5">IDR 640.000</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="py-5">
                                                <div className="py-3 border-bottom border-top">
                                                    <p className="mb-0 text-dark">IDR 1.930.000</p>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td className="py-5">
                                                <div className="py-3 border-bottom border-top">
                                                    <p className="mb-0 text-dark">IDR 1.938.000</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div className="row g-4 text-center align-items-center justify-content-center border-bottom py-3">
                                <div className="col-12">
                                    <div className="form-check text-start my-3">
                                        <input type="checkbox" className="form-check-input bg-primary border-0" id="E-Wallet-1" name="E-Wallet" value="E-Wallet" />
                                        <label className="form-check-label" for="Paypal-1">E-Wallet</label>
                                    </div>
                                </div>
                            </div>
